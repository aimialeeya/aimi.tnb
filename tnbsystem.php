  ...
  <div class="container">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="voltan" name="voltan" required>Voltage (V)
      </div>
      <div class="form-group">
        <label for="ampere">Current </label>
        <input type="number" class="form-control" id="ampere" name="ampere" required>Ampere (A)
      </div>
      <div class="form-group">
        <label for="time">Time </label>
        <input type="number" class="form-control" id="time" name="time" required>jam
      </div>
      <div class="form-group">
          <label for="rate">Current Rate </label>
        <input type="number" class="form-control" id="rate" name="rate" required>sen/kWh
      </div>
